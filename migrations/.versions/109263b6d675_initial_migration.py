...
Revision ID: 109263b6d675
Revises: 
Create Date: 2025-08-25 21:08:55.798387
...
def upgrade() -> None:
    ...
    sa.Column('license_type', sa.String(), server_default='trial', nullable=False),
    ...
    op.create_index(op.f('ix_organizations_primary_email'), 'organizations', ['primary_email'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_organizations_primary_email'), table_name='organizations')
