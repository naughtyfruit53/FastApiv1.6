"""after complete app revamp

Revision ID: a0e2cc05d20e
Revises: 
Create Date: 2025-08-28 15:26:18.602626
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_class WHERE relname = 'idx_journal_org_date'
    ) THEN
        CREATE INDEX idx_journal_org_date ON journal_vouchers (organization_id, date);
    END IF;
END$$;
""")
