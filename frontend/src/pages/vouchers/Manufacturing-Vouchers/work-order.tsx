    ...
    <Container maxWidth="lg">
      <Box sx={{ mt: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Manage production work orders, quality control, and manufacturing
          operations.
        </Typography>
        ...
        <Box sx={{ mt: 4, textAlign: "center" }}>
          ...
          >
            <Button
              variant="contained"
              onClick={() =>
                router.push("/vouchers/Manufacturing-Vouchers/production-order")
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                router.push(
                  "/vouchers/Manufacturing-Vouchers/material-requisition",
                )
              }
            >
