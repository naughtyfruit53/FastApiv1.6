      ...
      <Table stickyHeader size="small">
        ...
        <TableBody>
          {latestVouchers.length === 0 ? (
            <TableRow><TableCell colSpan={5} align="center">No sales vouchers available</TableCell></TableRow>
          ) : (
              ...
              <TableRow key={voucher.id} hover onContextMenu={(e) => { e.preventDefault(); handleContextMenu(e, voucher); }} sx={{ cursor: "pointer" }}>
                ...
                <TableCell align="right" sx={{ fontSize: 12, p: 0 }}>
                  <VoucherContextMenu
                    ...
                    onDuplicate={(id) => handleDuplicate(id, voucherList, reset, setMode, "Sales Voucher")}
                    showKebab={true}
                    onClose={() => {}}
                  />
                </TableCell>
