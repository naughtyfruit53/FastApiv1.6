              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      rfq_description: e.target.value,
                    }))
                  }
                  disabled={mode === "view"}
                />
                      ...
                      <TableRow key={index}>
                        <TableCell>
                          <TextField
                            ...
                            onChange={(e) =>
                              updateRFQItem(index, "item_code", e.target.value)
                            }
                            disabled={mode === "view"}
                        ...
                        <TableCell>
                          <TextField
                            ...
                            onChange={(e) =>
                              updateRFQItem(index, "item_name", e.target.value)
                            }
                            disabled={mode === "view"}
                        ...
                        <TableCell>
                          <TextField
                            ...
                            value={item.unit}
                            onChange={(e) =>
                              updateRFQItem(index, "unit", e.target.value)
                            }
                            disabled={mode === "view"}
                            placeholder="Unit"
                          />
          ...
          <DialogActions>
            ...
            {mode !== "view" && (
              <Button
                ...
                disabled={
                  createRFQMutation.isPending || updateRFQMutation.isPending
                }
              >
