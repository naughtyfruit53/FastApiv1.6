    ...
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Manage carriers, routes, freight rates, shipments, and logistics
          operations
        </Typography>
      </Box>
      {/* Dashboard Cards */}
                ...
                <Box>
                  ...
                  <Typography variant="h4">
                    {dashboardLoading ? (
                      ...
                      dashboardData?.total_carriers || 0
                    )}
                  </Typography>
                </Box>
                ...
                <Box>
                  ...
                  <Typography variant="h4">
                    {dashboardLoading ? (
                      ...
                      dashboardData?.active_shipments || 0
                    )}
                  </Typography>
                </Box>
                ...
                <Box>
                  ...
                  <Typography variant="h4">
                    {dashboardLoading ? (
                      ...
                      dashboardData?.delivered_this_month || 0
                    )}
                  </Typography>
                </Box>
      ...
      <TabPanel value={tabValue} index={4}>
        ...
        <Typography variant="body2" color="text.secondary">
          Enter shipment details above to compare freight rates across carriers
          and routes.
        </Typography>
      </TabPanel>
