    ...
    <Container maxWidth="lg">
      <Box sx={{ mt: 3 }}>
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          The Chart of Accounts is the foundation of your financial system. It
          categorizes all financial transactions and helps generate accurate
          financial reports.
        </Alert>
                  ...
                  >
                    <Box>
                      ...
                      <Typography variant="body2" color="textSecondary">
                        {
                          accounts.filter(
                            (acc) => acc.account_type === type.value,
                          ).length
                        }{" "}
                        accounts
                      </Typography>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    {accounts
                      .filter(
                        (acc) => acc.account_type === formData.account_type,
                      )
                      .map((account) => (
