...
const FeedbackWorkflowPage: NextPage = () => {
  ...
  const hasCustomerServicePermission = userPermissions.includes(
    SERVICE_PERMISSIONS.CUSTOMER_SERVICE_READ,
  );
    ...
    return (
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Alert severity="error">
          Access Denied: You don&apos;t have permission to view feedback
          workflows. Contact your administrator to request customer service
          permissions.
        </Alert>
      </Container>
    );
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Manage customer feedback collection, service closure workflows, and
