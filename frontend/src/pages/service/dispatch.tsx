...
const DispatchManagementPage: NextPage = () => {
  ...
  const hasWorkOrderPermission = userPermissions.includes(
    ...
    return (
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Alert severity="error">
          Access Denied: You don&apos;t have permission to view dispatch
          management. Contact your administrator to request work order
          permissions.
        </Alert>
      </Container>
    );
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Manage service dispatch orders, installation job scheduling, and
