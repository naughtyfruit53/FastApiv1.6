...
const ServiceAnalyticsPage: NextPage = () => {
  ...
  const hasServiceReportsPermission = userPermissions.includes(SERVICE_PERMISSIONS.SERVICE_REPORTS_READ);

  if (!user || !hasServiceReportsPermission) {
    return (
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Alert severity="error">
          Access Denied: You don&apos;t have permission to view service analytics. Contact your administrator to request the &quot;Service Reports Read&quot; permission.
        </Alert>
      </Container>
    );
  }
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Comprehensive service analytics including job completion, technician performance, customer satisfaction, and SLA compliance metrics.
        </Typography>
      </Box>
