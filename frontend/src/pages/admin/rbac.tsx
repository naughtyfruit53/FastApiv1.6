...
const RBACManagementPage: NextPage = () => {
  ...
  const hasCRMAdminPermission = userPermissions.includes(SERVICE_PERMISSIONS.CRM_ADMIN);
    ...
    return (
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Alert severity="error">
          Access Denied: You don&apos;t have permission to manage service roles and permissions. Contact your administrator to request CRM Admin permissions.
        </Alert>
      </Container>
    );
  }
  ...
  if (!organizationId) {
    return (
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Alert severity="error">
          Error: Unable to determine organization context. Please contact support.
        </Alert>
      </Container>
    );
  }
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Manage service CRM roles, permissions, and user assignments for your organization.
        </Typography>
      </Box>
