          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Paper sx={{ p: 3, height: "100%" }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Manage users within your organization. Add new users, edit
                existing ones, and control their access permissions.
              </Typography>
        ...
        {isOrgAdmin && (
          <Grid size={{ xs: 12, md: canManage ? 6 : 12 }}>
            <Paper sx={{ p: 3, height: "100%" }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Manage external integrations like Tally, Zoho, email services,
                and data migration. Configure connections and monitor
                integration health.
              </Typography>
              <Box sx={{ display: "flex", gap: 1, flexDirection: "column" }}>
                <Button
        ...
        {isAuthorized && (
          <Grid size={{ xs: 12, md: isOrgAdmin ? (canManage ? 4 : 6) : 12 }}>
            <Paper sx={{ p: 3, height: "100%" }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Advanced reset and recovery options. Use with caution as these
          ...
          <Grid size={{ xs: 12 }}>
            <Paper sx={{ p: 3 }}>
              <Typography variant="body1" color="text.secondary">
                Advanced options and user management are not available for your
                role: <strong>{displayRole}</strong>
              </Typography>
              <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
                Contact your organization administrator if you need access to
                additional features.
              </Typography>
            </Paper>
          </Grid>
