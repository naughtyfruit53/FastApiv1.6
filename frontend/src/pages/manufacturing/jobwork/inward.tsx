...
const InwardJobworkPage: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await api.post('/manufacturing/inward-jobwork', {
        vendor_id: data.party_id,
        date: data.date,
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['inward-jobwork-orders'] });
    },
  });
  ...
  return (
    ...
    <Container maxWidth="lg">
              ...
              <CardContent>
                ...
                >
                  <Box>
                    ...
                    <Typography variant="h4" component="h2">
                      {jobworkOrders.filter((j: any) => j.status === 'sent' || j.status === 'in_process').length}
                    </Typography>
                  </Box>
      ...
      <JobworkModal
        ...
        direction="inward"
        title="Create Inward Jobwork Order"
      />
