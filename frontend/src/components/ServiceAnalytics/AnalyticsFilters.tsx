...
const AnalyticsFilters: React.FC<AnalyticsFiltersProps> = ({
  ...
  const handlePeriodChange = (period: ReportPeriod) => {
    const updatedFilters = {
      ...
      start_date:
        period === ReportPeriod.CUSTOM ? localFilters.start_date : undefined,
      end_date:
        period === ReportPeriod.CUSTOM ? localFilters.end_date : undefined,
    };
  ...
  const selectedTechnician =
    technicians.find((t) => t.id === localFilters.technician_id) || null;
  const selectedCustomer =
    customers.find((c) => c.id === localFilters.customer_id) || null;
  return (
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <FormControl fullWidth>
              ...
              <Select
                ...
                label="Period"
                onChange={(e) =>
                  handlePeriodChange(e.target.value as ReportPeriod)
                }
              >
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Autocomplete
              ...
              onChange={(_, newValue) =>
                handleTechnicianChange(newValue?.id || null)
              }
              renderInput={(params) => (
                <TextField
                  {...params}
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Autocomplete
              ...
              onChange={(_, newValue) =>
                handleCustomerChange(newValue?.id || null)
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                ...
                localFilters.end_date && (
                  ...
                  >
                    <Typography variant="caption" color="info.contrastText">
                      Custom Range: {localFilters.start_date} to{" "}
                      {localFilters.end_date}
                    </Typography>
                  </Box>
                )}
