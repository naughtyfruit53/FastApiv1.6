...
const CustomerAnalytics: React.FC<CustomerAnalyticsProps> = ({
  ...
  const [includeRecentInteractions, setIncludeRecentInteractions] =
    useState(true);
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e) =>
                    setIncludeRecentInteractions(e.target.checked)
                  }
                />
              }
          ...
          {includeRecentInteractions && (
            <Grid size={{ xs: 12 }}>
              <TextField
                ...
                onChange={(e) =>
                  setRecentInteractionsLimit(Number(e.target.value))
                }
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Card>
            <CardContent>
              ...
              <Box>
                {Object.entries(analytics.interaction_types).map(
                  ([type, count]) => (
                    <Box
                      key={type}
                      display="flex"
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Card>
            <CardContent>
              ...
              <Box>
                {Object.entries(analytics.interaction_status).map(
                  ([status, count]) => (
                    <Box
                      key={status}
                      display="flex"
                        ...
                        <TableRow key={index}>
                          ...
                          <TableCell>
                            {segment.segment_value
                              ? segment.segment_value.toFixed(2)
                              : "-"}
                          </TableCell>
                          <TableCell>
                            {formatDate(segment.assigned_date)}
                          </TableCell>
                ...
                <CardContent>
                  ...
                  <TableContainer>
                    <Table size="small">
                      ...
                      <TableBody>
                        {analytics.recent_interactions.map(
                          (interaction, index) => (
                            <TableRow key={index}>
                              <TableCell>
                                <Chip
                              ...
                              <TableCell>
                                <Chip
                                  ...
                                  color={
                                    getStatusColor(interaction.status) as any
                                  }
                                  size="small"
                                />
                              </TableCell>
