  ...
  reportsAnalytics: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { name: 'Customer Analytics', path: '/analytics/customer', icon: <TrendingUp />, permission: 'reports.view', requireModule: 'reports', requireSubmodule: { module: 'reports', submodule: 'customer_analytics' } },
          { name: 'Sales Analytics', path: '/analytics/sales', icon: <BarChart />, permission: 'reports.view', requireModule: 'reports', requireSubmodule: { module: 'reports', submodule: 'sales_analytics' } },
          { name: 'Purchase Analytics', path: '/analytics/purchase', icon: <ShoppingCart />, permission: 'reports.view', requireModule: 'reports', requireSubmodule: { module: 'reports', submodule: 'purchase_analytics' } }
        ]
      },
      {
    ...
    sections: [
      {
        title: 'Tasks',
        items: [
          { name: 'Task Dashboard', path: '/tasks/dashboard', icon: <Dashboard />, permission: 'tasks_calendar.view', requireModule: 'tasks_calendar', requireSubmodule: { module: 'tasks_calendar', submodule: 'task_dashboard' } },
