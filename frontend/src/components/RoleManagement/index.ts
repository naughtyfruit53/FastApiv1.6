...
export const _COMPONENT_DOCS = {
  RoleManagement: {
    description:
      "Main role management interface with tabbed view for roles, user assignments, and permission matrix",
    props: {
  ...
  RoleFormDialog: {
    description:
      "Dialog for creating and editing service roles with permission assignment",
    props: {
  ...
  ServiceRoleGate: {
    description:
      "Enhanced role gate component supporting both system roles and service permissions",
    props: {
      requiredPermissions: "string[] - Service permissions required",
      requiredRoles: "string[] - System roles required",
      requireAll:
        "boolean - Whether all permissions/roles are required (default: true)",
