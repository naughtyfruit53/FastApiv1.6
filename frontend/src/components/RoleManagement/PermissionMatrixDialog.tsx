...
const PermissionMatrixDialog: React.FC<PermissionMatrixDialogProps> = ({
  ...
  const [selectedModule, setSelectedModule] = useState<ServiceModule | "all">(
    "all",
  );
  ...
  const getModuleStats = (
    ...
    const grantedInModule = role.permissions.filter(
      (p) => p.module === module,
    ).length;
    ...
    return {
      ...
      percentage:
        totalInModule > 0
          ? Math.round((grantedInModule / totalInModule) * 100)
          : 0,
    };
  };
  return (
          ...
          >
            ...
            <FormControl size="small" sx={{ minWidth: 200 }}>
              ...
              <Select
                ...
                onChange={(e) =>
                  setSelectedModule(e.target.value as ServiceModule | "all")
                }
                      ...
                      >
                        ...
                        >
                          ...
                          <Typography variant="caption">
                            {getRoleStats(role).granted}/
                            {getRoleStats(role).total}
                          </Typography>
                        </Box>
                      </TableCell>
                    ))}
                      ...
                      >
                        <Box>
                          ...
                          <Typography variant="caption" color="text.secondary">
                            {MODULE_DISPLAY_NAMES[permission.module]} •{" "}
                            {permission.action}
                          </Typography>
                ...
                return (
                  <Accordion
                    ...
                    onChange={(_, isExpanded) =>
                      setExpandedRole(isExpanded ? role.id.toString() : false)
                    }
                  >
