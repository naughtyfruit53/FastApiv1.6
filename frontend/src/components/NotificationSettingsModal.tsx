...
import Restore from "@mui/icons-material/Restore"; // Using Restore as equivalent
...
const NotificationSettingsModal: React.FC<NotificationSettingsModalProps> = ({
  ...
  const notificationTypes = [
    ...
    },
    {
      key: "job_update",
      label: "Job Updates",
      description: "When job status or details change",
    },
    {
      key: "job_completion",
    ...
    },
    {
      ...
      description: "When feedback is requested",
    },
    {
      key: "sla_breach",
      label: "SLA Breach Alerts",
      description: "When SLA deadlines are at risk",
    },
    {
    ...
    },
    {
      ...
      description: "When service work is completed",
    },
    {
      key: "follow_up",
    ...
    if (currentPreferences.length > 0) {
      ...
      notificationTypes.forEach((type) => {
        ...
        NOTIFICATION_CHANNELS.forEach((channel) => {
          ...
          prefState[type.key][channel] = existing
            ? existing.is_enabled
            : defaultEnabled;
        });
      });
  ...
  const handleSelectAll = (notificationType: string, enabled: boolean) => {
    setPreferences((prev) => ({
      ...prev,
      [notificationType]: NOTIFICATION_CHANNELS.reduce(
        (acc, channel) => ({
          ...acc,
          [channel]: enabled,
        }),
    ...
    >
      ...
      <DialogContent>
        <Alert severity="info" sx={{ mb: 3 }}>
          ...
          You can enable or disable notifications for each channel (email, SMS,
          push, in-app).
        </Alert>
        {isLoading ? (
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", gap: 1 }}>
                      <Chip
                        ...
                        size="small"
                        color={
                          getEnabledChannelsCount(type.key) > 0
                            ? "primary"
                            : "default"
                        }
                        variant="outlined"
                            ...
                            >
                              ...
                              <FormControlLabel
                                control={
                                  <Switch
                                    checked={
                                      preferences[type.key]?.[channel] || false
                                    }
                                    onChange={(e) =>
