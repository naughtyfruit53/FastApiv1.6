...
const mockGetProductStock = getProductStock as jest.MockedFunction<
...
describe("StockDisplay", () => {
  ...
  it("renders nothing when productId is null", () => {
    const { container } = render(<StockDisplay productId={null} />, {
  ...
  it("displays stock information when product is selected", async () => {
    ...
    render(<StockDisplay productId={1} />, { wrapper: createWrapper() });
  ...
  it("renders nothing when stock data is null", async () => {
    ...
    const { container } = render(<StockDisplay productId={1} />, {
      wrapper: createWrapper(),
    });
