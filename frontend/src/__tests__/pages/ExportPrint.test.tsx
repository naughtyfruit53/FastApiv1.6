...
const mockCanAccessLedger = canAccessLedger as jest.MockedFunction<
  typeof canAccessLedger
>;
...
describe("Export and Print Functionality", () => {
  beforeEach(() => {
    ...
    mockReportsService.exportSalesReportExcel.mockResolvedValue(
      new Blob(["test"], {
        type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      }),
    );
    mockReportsService.exportPurchaseReportExcel.mockResolvedValue(
      new Blob(["test"], {
        type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      }),
    );
    mockReportsService.exportInventoryReportExcel.mockResolvedValue(
      new Blob(["test"], {
        type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      }),
    );
    mockReportsService.exportPendingOrdersExcel.mockResolvedValue(
      new Blob(["test"], {
        type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      }),
    );
  ...
  describe("Inventory Report Export", () => {
    ...
    it("should call export function when export button is clicked", async () => {
      ...
      await waitFor(() => {
        expect(
          mockReportsService.exportInventoryReportExcel,
        ).toHaveBeenCalled();
      });
    });
  });
  ...
  describe("Advanced Filtering", () => {
    it("should show search filters in sales report", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByPlaceholderText("Search vouchers..."),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Error Handling", () => {
    it("should handle export errors gracefully", async () => {
      mockReportsService.exportSalesReportExcel.mockRejectedValue(
