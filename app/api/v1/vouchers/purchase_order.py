...
from app.schemas.vouchers.purchase import PurchaseOrderCreate, PurchaseOrderInDB, PurchaseOrderUpdate, TrackingUpdate
...
async def update_purchase_order_tracking(
    ...
    try:
        ...
        if tracking.transporter_name is not None:
            po.transporter_name = tracking.transporter_name
        if tracking.tracking_number is not None:
            po.tracking_number = tracking.tracking_number
        if tracking.tracking_link is not None:
            po.tracking_link = tracking.tracking_link
