# app/api/v1/sales_orders.py
"""
Top-level Sales Orders router
Provides /api/v1/sales-orders endpoint as an alias to /api/v1/vouchers/sales-orders
"""
...
from app.models.order_book_models import Order
import logging
...
# Top-level router at /api/v1/sales-orders
...
async def get_sales_orders(
    ...
    """Get all sales orders with pagination and sorting"""
...
async def create_sales_order(
    ...
    """Create new sales order with customer_voucher_number support"""
    current_user, org_id = auth
