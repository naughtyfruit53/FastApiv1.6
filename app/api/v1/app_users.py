...
async def create_app_user(
    ...
    try:
        ...
        # Keep the requested role (don't override to SUPER_ADMIN)
        ...
        try:
            # Set is_super_admin flag based on role
            is_super_admin = user_data.role == UserRole.SUPER_ADMIN
        ...
        try:
            ...
            db_user = User(
                ...
                full_name=user_data.full_name,
                role=user_data.role,  # Use the requested role
                department=user_data.department,
                designation=user_data.designation,
                employee_id=user_data.employee_id,
                phone=user_data.phone,
                is_active=True,
                is_super_admin=is_super_admin,  # True only for SUPER_ADMIN role
