...
class FinancialModelBase(BaseModel):
    ...
    analysis_start_date: date = Field(..., description="Analysis period start date")
    analysis_end_date: date = Field(..., description="Analysis period end date")
...
class TradingComparablesBase(BaseModel):
    ...
    as_of_date: date = Field(..., description="Date of the financial data")
...
class TransactionComparablesBase(BaseModel):
    ...
    transaction_date: date = Field(..., description="Transaction completion date")
...
class ValuationSummary(BaseModel):
    ...
    # Analysis date
    analysis_date: date = Field(..., description="Date of the valuation analysis")
