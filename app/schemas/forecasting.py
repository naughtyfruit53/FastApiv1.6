...
class FinancialForecastBase(BaseModel):
    ...
    base_period_start: date = Field(..., description="Historical data period start")
    base_period_end: date = Field(..., description="Historical data period end")
    forecast_start: date = Field(..., description="Forecast period start")
    forecast_end: date = Field(..., description="Forecast period end")
...
class MLForecastModelBase(BaseModel):
    ...
    training_period_start: date = Field(..., description="Training data start date")
    training_period_end: date = Field(..., description="Training data end date")
...
class PredictionRequest(BaseModel):
    ...
    prediction_date: date = Field(..., description="Date to predict for")
...
class RiskEventCreate(RiskEventBase):
    ...
    event_date: date = Field(..., description="Date of the risk event")
...
class MultiVariateForecastRequest(BaseModel):
    """Request for multivariate forecasting"""
...
class ScenarioForecastRequest(BaseModel):
    """Request for scenario-based forecasting"""
...
class ForecastDashboardData(BaseModel):
    """Dashboard data for forecasting overview"""
