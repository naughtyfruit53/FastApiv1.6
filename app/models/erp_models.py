...
class GeneralLedger(Base):
    """General Ledger for comprehensive financial tracking"""
    ...
    reference_type = Column(String(50), nullable=True, index=True)  # voucher, journal, payment, etc.
    reference_id = Column(Integer, nullable=True, index=True)
    ...
    is_reconciled = Column(Boolean, default=False, nullable=False)
    reconciled_date = Column(Date, nullable=True)
    reconciled_by = Column(Integer, ForeignKey("platform_users.id"), nullable=True)
